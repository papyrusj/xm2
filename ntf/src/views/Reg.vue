  ...
  <div class="container-fluid p-0">
    ...
    <div class="my_content position-relative">
      <div class="bg-white position-absolute">
        <h5 class="font-weight-bold">快速登录/注册</h5>
          <ul class="reg_ul list-unstyled">
            <li>
              <input class="w-100" type="text" v-model="phone" id="phone" value="" placeholder="手机号"/>
            </li>
            <li>
              <input type="text" name="code" id="code" placeholder="填写验证码" v-model="code"/>
              <span type="text" id="getCode">4399</span>
              <a class="change" href="#" >看不清楚？换一个</a>
            </li>
            <li>
              <input type="text" name="msgCode" id="msg" value="" placeholder="填写验证码"/>
              <a class="msg" href="#">
                获取短信验证码
              </a>
            </li>
            <li>
              <input type="checkbox"/>
              <a class="font_small" href="">
                我同意TheNorthFace & reg北面官网服务条款
              </a>
            </li>
            <li class="btn_li">
              <button @click="regin()" class="btn_login border-0 text-white">
                立即登录
              </button>
            </li>
          </ul>
...
.reg_ul{margin-top: 25px; margin-bottom: 10px; color: #666;}
...
top: 318px;}
#getCode{width: 60px; height:32px; font-weight: 500; font-family: georgia; font-size: 23px; margin-left: 8px; margin-right: 12px; cursor: pointer; color: black;}
.msg_alert{background-color: #fff; width: 352px;padding: 30px 50px;
  border: 1px solid #a3afb9; text-align: center;box-shadow: 2px 2px 1px rgba(150, 150, 150, 0.5); font-size: 14px; position: absolute; left: 607px;
  top: 318px;}
</style>
